...
export const districts: District[] = [
  ...
  },
  {
    ...
    name: "Ankara",
    city: "Ankara",
    seoTitle: "Ankara Halı Yıkama | Ücretsiz Kapıdan Alım-Teslim",
    metaDescription:
      "Ankara'da halı, stor perde, yorgan ve battaniye yıkama; Çankaya, Ümitköy, Çayyolu, Bağlıca, Eryaman, Batıkent ve çevresine ücretsiz kapıdan alım-teslim. WhatsApp'tan hemen teklif alın.",
    h1: "Ankara Halı Yıkama",
    intro: [
      "Ankara'da halılarınızı yıkamaya götürmenin bilinen bir zahmeti var: ağır halıyı asansöre sığdırmak, aracınıza yüklemek, bir yıkamacıya bırakıp günler sonra geri almak. Yakamoz Halı Yıkama olarak bu işi tersine çeviriyoruz — siz arayın ya da WhatsApp'tan yazın, halılarınızı kapınızdan alıp tesisimizde yıkıyor, tertemiz ve kurumuş şekilde yine kapınıza teslim ediyoruz.",
      "Çankaya ve çevresindeki Ümitköy, Çayyolu, Bağlıca, Mustafa Kemal hattından Eryaman, Susuz, Yapracık ve Batıkent, Yenikent bölgelerine kadar geniş bir alanda ücretsiz kapıdan alım-teslim ile çalışıyoruz. Makine halısından el dokuma, Isparta, Nepal ve Afgan halısına kadar farklı türleri dokusuna zarar vermeden yıkıyor; kesin fiyatı halının türü, ölçüsü ve adedine göre önceden netleştiriyoruz.",
    ],
    mahalleler: [
      "Çankaya",
      "Ümitköy",
    ...
    mahalleNote:
      "Ankara'da yukarıdaki bölgelerin tamamına ücretsiz kapıdan alım-teslim ile hizmet veriyoruz; bölgeniz listede yoksa WhatsApp'tan teyit alabilirsiniz.",
    faq: [
      {
        question: "Ankara'da fiziksel bir şubeniz var mı, halıyı bırakabilir miyim?",
        answer:
      ...
      {
        question: "Ankara'da hangi bölgelere geliyorsunuz?",
        answer:
          "Çankaya, Ümitköy, Çayyolu, Bağlıca, Mustafa Kemal, Yapracık, Eryaman, Susuz, Batıkent ve Yenikent bölgelerine ücretsiz kapıdan alım-teslim yapıyoruz.",
      },
      {
        question: "Fiyat nasıl belirleniyor?",
        answer:
          "Fiyat; halının türü, ölçüsü ve adedine göre değişir. Sitedeki fiyat hesaplama aracından şehir olarak Ankara'yı seçip tahmini tutarı görebilir, WhatsApp'tan fotoğraf/ölçü paylaşarak net teklif alabilirsiniz.",
      },
      {
        question: "Stor ve zebra perde ile overlok hizmetiniz var mı?",
        answer:
          "Evet; stor ve zebra perdeleriniz sökülür, yıkanır, ütülenir ve talep ederseniz yerine asılır. Halı kenarı için metre başı overlok hizmeti de veriyoruz.",
      },
    ],
  },
  {
    ...
    name: "Osmaniye",
    city: "Osmaniye",
    seoTitle: "Osmaniye Halı Yıkama | Ücretsiz Kapıdan Alım-Teslim",
    metaDescription:
      "Osmaniye'de halı, stor perde, yorgan ve battaniye yıkama; ücretsiz kapıdan alım-teslim ile şehir genelinde hizmet. WhatsApp'tan hemen teklif alın.",
    h1: "Osmaniye Halı Yıkama",
    intro: [
      "Osmaniye, Çukurova'nın doğusunda, Adana'ya komşu kompakt bir şehir; ilçe ve mahalleler birbirine yakın olduğu için kapıdan alım-teslim burada özellikle pratik işliyor. Yakamoz Halı Yıkama olarak Osmaniye genelinde halılarınızı kapınızdan alıyor, tesisimizde yıkıyor, tertemiz ve kurumuş şekilde yine kapınıza teslim ediyoruz.",
      "Makine halısından el dokuma, Isparta, Nepal ve Afgan halısına kadar farklı türleri dokusuna uygun yöntemlerle yıkıyor; stor ve zebra perde, yorgan, battaniye ve halı kenarı overlok hizmetini de aynı ücretsiz alım-teslim turunda sunuyoruz. Kesin fiyatı halının türü, ölçüsü ve adedine göre önceden söylüyoruz.",
    ],
    mahalleler: [
      "Merkez",
      "Rauf Bey",
    ...
    mahalleNote:
      "Osmaniye şehir genelinde ücretsiz kapıdan alım-teslim ile hizmet veriyoruz; en yoğun çalıştığımız bölgelerden bazıları yukarıda listelidir.",
    faq: [
      {
      ...
      },
      {
        question: "Hangi halı türlerini yıkıyorsunuz?",
        answer:
          "Makine halısı, jel halı, akrilik, shaggy, Isparta, Nepal, viskoz, bambu, el dokuma ve Afgan halısı türlerini yıkıyoruz.",
      },
      {
        question: "Fiyat nasıl belirleniyor?",
        answer:
          "Sitedeki fiyat hesaplama aracından şehir olarak Osmaniye'yi seçip tahmini tutarı görebilir, WhatsApp'tan ölçü veya fotoğraf paylaşarak net teklif alabilirsiniz.",
      },
      {
        question: "Yorgan, battaniye ve perde için ayrı randevu mu almalıyım?",
        answer:
          "Hayır; halı ile aynı randevuda stor/zebra perde, yorgan ve battaniyelerinizi de alabiliyoruz.",
      },
    ],
  },
];
